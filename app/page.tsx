...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-background pt-18">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/all-classes"
              className="px-6 py-3 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700 transition-colors"
            >
              Browse Classes
            </Link>
            <Link
              href="/my-classes"
              className="px-6 py-3 border-2 border-gray-300 dark:border-gray-700 text-foreground rounded-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
            >
              My Classes
            </Link>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                <div className="flex-shrink-0 w-10 h-10 bg-red-600 dark:bg-red-600 text-white rounded-full flex items-center justify-center font-bold text-lg">
                  1
                </div>
                <div>
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-3xl mx-auto text-center bg-gradient-to-r from-red-600 to-green-600 rounded-2xl p-12 text-white">
          ...
          <Link
            href="/all-classes"
            className="inline-block px-8 py-3 bg-white text-red-600 dark:bg-gray-900 dark:text-red-400 rounded-lg font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          >
            Explore Classes
          </Link>
        </div>
